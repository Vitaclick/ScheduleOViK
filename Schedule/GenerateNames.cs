...
namespace Schedule
{
    ...
    public class GenerateNames : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                //engine.ExecuteFile("C:/Drive/ARMOPlug/ScriptPy/GenerateNames.py", scope);

                string scriptName = Assembly.GetExecutingAssembly().GetName().Name + ".Resources." + "GenerateNames.py";
